    ...
    $insert_query1 = "select * from comments where post_id=$q";
        ...
        if(mysqli_num_rows($res1)>0){
           ...
           while($row1=mysqli_fetch_assoc($res1)){
            ...
            <div class=\"col-6 col-md-4\"><small>$row1[time] por <b>$row1[author]</b></small></div>
            </div>
            </div>
            </div>";
            ...
            echo "<div class=\"container\"><center>Nenhum comentário postado</center></div>";
        }
        ...
        ?>
            ...
            <input type="text" name="comment" class="form-control" placeholder="Digite o comentário" aria-label="Recipient's username" aria-describedby="basic-addon2">
            <div class="input-group-append">
            <button class="btn btn-outline-dark" type="submit" name="submit">Postar Comentario</button>
            </div>
            </div>
