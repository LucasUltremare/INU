      ...
      <div class="container">
        ...
        <nav class="navbar navbar-expand-sm navbar-light">
            <div class="navbar-nav">
              <a class="nav-item nav-link active" href="index.php">Todos <span class="sr-only">(current)</span></a>
              <a class="nav-item nav-link" href="electronics.php">Matematica</a>
              <a class="nav-item nav-link" href="tv.php">Literatura</a>
              <a class="nav-item nav-link" href="men.php">Física</a>
              <a class="nav-item nav-link" href="women.php">Quimica</a>
              <a class="nav-item nav-link" href="baby.php">Biologia</a>
...
mysqli_select_db($con,"forum");
            ...
            $insert_query = "select * from forum where topic='Home & Furniture' order by id desc";
