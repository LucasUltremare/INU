...
<head>
    ...
    <title>Perfio do Estudante</title>
 ...
 ?>
    ...
    <div class="content-wrapper">
        <div class="container">
              <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Registro do Estudante </h1>
                    </div>
                </div>
                <div class="row" >
...
{ ?>
 ...
 <div class="form-group">
    <label for="studentregno">Nome de Usuario do Estudante </label>
...
<div class="form-group">
    <label for="Pincode">Codigo </label>
...
<div class="form-group">
    <label for="Pincode">Foto do Estudante </label>
...
<div class="form-group">
    <label for="Pincode">Colocar nova foto  </label>
 ...
 <button type="submit" name="submit" id="submit" class="btn btn-default">Atualizar</button>
</form>
                            </div>
                            </div>
                    </div>
